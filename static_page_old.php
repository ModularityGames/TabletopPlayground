...
<body>
	...
	<section id="landing" class="hero is-fullheight is-dark is-bold">
		...
		<div class="hero-head">
			<div class="container">
				<nav class="level">
					...
					<p class="level-item has-text-centered">
						<a href="https://discord.gg/4AeJmuV" class="link is-info is-size-6" target="_blank">Discord</a>
					</p>
				</nav>
			</div>
		</div>
		<div class="hero-body is-hidden-mobile">
			<iframe width="800" height="450" src="https://www.youtube.com/embed/mk2Z2p6LY6w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
		<div class="hero-foot has-text-centered">
			...
			<a href="#creators" class="button is-info is-rounded">
				<span>Join the Creators Beta</span>
			</a>
		</div>
	</section>

	<section id="creators" class="hero is-medium is-dark">
		<div class="hero-body">
			<div class="container has-text-centered">
				<div class="content">
					<h2 class="title is-size-4-mobile">Join the Creators Beta</h2>
					<p>Love boardgames and interested in playing Tabletop Playground before anyone else? In the lead up to our 2020 launch, we are running a beta for creators only. <a href="https://discord.gg/4AeJmuV" style="text-decoration: underline;" target="_blank">Join our Discord</a> and fill in the form below to apply.</p>
				</div>

				<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSc0P_hBDyDr36JdL2Kw662ktXe_ThW-NG30onZfXdlvsFpeew/viewform#mG61Hd" frameborder="0" width="800" height="800" style="max-height: 80vh;"></iframe>
			</div>
		</div>
	</section>

	<section id="about" class="hero is-medium is-white" style="background: #fff !important;">
		<div class="hero-body">
			<div class="container has-text-centered">
				<div class="content">
			...
			<div class="container has-text-centered">
				...
				<div class="tile is-ancestor">
					<div class="tile is-parent">
						<a href="https://www.youtube.com/embed/mk2Z2p6LY6w" class="tile tile-trailer is-child box" style="background: url(https://tabletop-playground.com/wp-content/uploads/video2.jpg) no-repeat center center; background-size: cover; padding: 0; border-radius: 0;" target="_blank">
					...
					<div class="tile is-3 is-vertical is-parent">
						...
						<a href="https://tabletop-playground.com/wp-content/uploads/screen2.jpg" class="tile tile-screenshot is-child box">
							<figure class="image is-16by9">
								<img src="https://tabletop-playground.com/wp-content/uploads/thumb-screen2.jpg" alt="Tabletop Playground">
							</figure>
						</a>
					</div>
					<div class="tile is-3 is-vertical is-parent">
				...
				<div class="tile is-ancestor">
					...
					<div class="tile is-3 is-parent">
						<a href="https://tabletop-playground.com/wp-content/uploads/screen8.jpg" class="tile tile-screenshot is-child box">
							<figure class="image is-16by9">
								<img src="https://tabletop-playground.com/wp-content/uploads/thumb-screen8.jpg" alt="Tabletop Playground">
							</figure>
						</a>
					</div>
				</div>
	...
	<section id="buy" class="hero is-dark">
		<div class="hero-body">
			<div class="container has-text-centered">
				<div class="content">
					<h2 class="title is-size-4-mobile">Wishlist now</h2>
					<p>Tabletop Playground will be releasing in 2020, and will be available on PC, Mac, Linux and VR from <a href="https://store.steampowered.com/app/838410/Tabletop_Playground/" style="text-decoration: underline;" target="_blank">Steam</a> and <a href="https://plasticitystudios.itch.io/tabletop-playground" style="text-decoration: underline;" target="_blank">itch.io</a>. More stores to come. But... if you cannot wait, we are running a <a href="#creators" style="text-decoration: underline;">creators beta</a> in partnership with mod.io, for modders interested in using the in-game editor to make tabletop games for the community to play on launch.</p>
				</div>
	...
	<footer id="footer" class="footer">
		<div class="content has-text-centered has-text-white">
			<p>❤ Tabletop Gaming since Chess. Find us on <a href="https://store.steampowered.com/app/838410/Tabletop_Playground/" target="_blank">Steam</a>, <a href="https://plasticitystudios.itch.io/tabletop-playground" target="_blank">itch.io</a>, <a href="https://tabletopplayground.mod.io" target="_blank">Mod.io</a>, <a href="https://www.indiedb.com/games/tabletop-playground" target="_blank">IndieDB</a>, <a href="https://discord.gg/4AeJmuV" target="_blank">Discord</a>, <a href="https://www.facebook.com/TabletopPlayground" target="_blank">Facebook</a>, <a href="https://twitter.com/TabletopPG" target="_blank">Twitter</a> or <a href="mailto:contact@tabletop-playground.com">email us</a>.</p>
