...
<body>
	...
	<section id="landing" class="hero is-fullheight is-dark is-bold">
		...
		<div class="hero-foot has-text-centered">
			...
			<a href="https://store.steampowered.com/app/1282050/Tabletop_Playground_Beta/" class="button is-info is-rounded">
				<span>Join the Open Beta</span>
			</a>
		</div>
	</section>
	...
	<section id="about" class="hero is-medium is-dark">
		<div class="hero-body" style="padding-top: 4rem;">
			<div class="container has-text-centered">
				<div class="content">
					<iframe src="https://store.steampowered.com/widget/1282050/" frameborder="0" width="646" height="190"></iframe>
					<br><br>
		...
		<div class="hero-body">
			<div class="container has-text-centered">
				<div class="content">
					...
					<p>Tabletop Playground will be releasing in 2020, and will be available on PC, Mac, Linux and VR from <a href="https://store.steampowered.com/app/838410/Tabletop_Playground/" style="text-decoration: underline;" target="_blank">Steam</a> and <a href="https://plasticitystudios.itch.io/tabletop-playground" style="text-decoration: underline;" target="_blank">itch.io</a>. More stores to come. But... if you cannot wait, we are running an <a href="https://store.steampowered.com/app/1282050/Tabletop_Playground_Beta/" style="text-decoration: underline;" target="_blank">open beta</a> on Steam, for creators and players interested to play tabletop games ahead of our official launch.</p>
				</div>
